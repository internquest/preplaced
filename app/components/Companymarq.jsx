...
// const transmotion=useTransform(scrollYProgress,[0,1],["0px","-100px"])
  return (
    ...
    <div className="flex pt-[80px] justify-between flex-[0_0_auto] gap-[30px]">


        <div class="box-border">
            <div style={{transform:`translate3d(0px,${translateval*250}px,0px) `}} role="list" class="box-border flex flex-col justify-center gap-y-[16px] mt-[30px]  [transform-style:preserve-3d]">
                ...
                <div role="listitem" class="box-border overflow-hidden w-[175px] h-[175px] min-h-[175px] min-w-[175px] rounded-[24px]">
        ...
        {/* 2nd */}
        <div>
        <div style={{transform:`translate3d(0px,${-translateval*250}px,0px) `}} role="list" class="box-border flex flex-col justify-center gap-y-[16px] mb-[30px] [transform:translate3d(0px,_0.638px,_0px)_scale3d(1,_1,_1)_rotateX(0deg)_rotateY(0deg)_rotateZ(0deg)_skew(0deg,_0deg)] [transform-style:preserve-3d]">
        ...
        {/* 3rd */}
        <div>
        <div style={{transform:`translate3d(0px,${translateval*250}px,0px) `}} role="list" class="box-border flex flex-col justify-center gap-y-[16px] [transform:translate3d(0px,_-0.638px,_0px)_scale3d(1,_1,_1)_rotateX(0deg)_rotateY(0deg)_rotateZ(0deg)_skew(0deg,_0deg)] [transform-style:preserve-3d]">
        <div role="listitem" class="box-border overflow-hidden w-[175px] flex justify-center items-center bg-white h-[175px] min-h-[175px] min-w-[175px] rounded-[24px]">
        ...
        {/* 6th */}
        <div>
        <div style={{transform:`translate3d(0px,${translateval*250}px,0px) `}} role="list" class="box-border flex flex-col justify-center gap-y-[16px] mt-[30px] [transform:translate3d(0px,_-1.276px,_0px)_scale3d(1,_1,_1)_rotateX(0deg)_rotateY(0deg)_rotateZ(0deg)_skew(0deg,_0deg)] [transform-style:preserve-3d]">
        <div role="listitem" class="box-border overflow-hidden w-[175px] flex justify-center items-center bg-white h-[175px] min-h-[175px] min-w-[175px] rounded-[24px]">
